...
| P8-X | **exit criteria:** E8.1 + E8.2 bars met → owner decides adoption (changes a pinned S-§9 default ⇒ re-freeze required before any new confirmatory claim) | — | — | phase gate — **awaiting owner adoption decision** | ◐ | |
