...
1. **Explanations**: When asked to explain something, explain it in practical terms — concise and to the point — unless explicitly requested otherwise.

2. **Branching**: Always do new work on a branch. Only merge to `main` and push after explicit approval from the user.
