"""E1.3 — pressure-strength calibration (pre-registered after the E1.1 finding).
...
def main() -> int:
    ...
    out = {"experiment": "E1.3", "dataset": DATASET,
           ...
           "chosen_lambdas": ({"lambda_act": BASE_ACT * chosen,
                              ...
                              if chosen else None)}
    save_json(ROOT / "experiments" / "results" / "e13.json", out)
    for row in table:
