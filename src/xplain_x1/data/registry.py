...
from .loaders import (load_adult, load_bike, load_drybean, load_german_credit,
                      load_morpher, load_mushroom, load_spambase,
                      load_taiwan_credit, load_tictactoe, load_wine, load_zoo)
